...
import br.ufpa.ecommerce.service.mapper.UsuarioMapper;
...
class UsuarioResourceIT {
    ...
    void partialUpdateUsuarioWithPatch() throws Exception {
        ...
        partialUpdatedUsuario.nome(UPDATED_NOME).dataNascimento(UPDATED_DATA_NASCIMENTO).criado(UPDATED_CRIADO);
