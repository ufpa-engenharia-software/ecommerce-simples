...
import br.ufpa.ecommerce.service.EnderecoQueryService;
import br.ufpa.ecommerce.service.EnderecoService;
...
/**
 * REST controller for managing {@link br.ufpa.ecommerce.domain.Endereco}.
 */
@RestController
@RequestMapping("/api")
